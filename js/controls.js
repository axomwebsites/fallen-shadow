...
g.lineWidth = 3;
let sx = (joystick.startx / window.innerWidth) * 960;
let sy = (joystick.starty / window.innerHeight) * 540;
let cx = (joystick.curx / window.innerWidth) * 960;
let cy = (joystick.cury / window.innerHeight) * 540;
g.beginPath();
g.arc(sx, sy, 50, 0, Math.PI*2);
g.fill();
g.stroke();
